        ...
        <div class="images">
            ...
            <div class="grid-plants">
             ...
             <a href="#" class="plant-box grid plant-grid2">
                 <div class="plant-bio">
                     <h1 class="plant-name">Escalope</h1>
					 <form action="php/ajouter.php" method="POST"class="adder">
                         <input type="hidden" name="name" value="Escalope">
                     <input  type="submit" name="add_to_cart" value="ADD">
                     </form>
                     <h3 class="plant-price">10DT</h3>
             ...
             <a href="#" class="plant-box grid plant-grid3">
                 <div class="plant-bio">
                     <h1 class="plant-name">Cordon bleu</h1>
					 <form action="php/ajouter.php" method="POST"class="adder">
                         <input type="hidden" name="name" value="Cordon bleu">
                     <input  type="submit" name="add_to_cart" value="ADD">
                     </form>
             ...
             <a href="#" class="plant-box grid plant-grid4">
                 <div class="plant-bio">
                     <h1 class="plant-name">Fromages</h1>
					 <form action="php/ajouter.php" method="POST"class="adder">
                         <input type="hidden" name="name" value="Fromages">
                     <input  type="submit" name="add_to_cart" value="ADD">
                     </form>
             ...
             <a href="#" class="plant-box grid plant-grid5">
                 ...
                 <a href="#" class="plant-box grid plant-grid6">
                    <div class="plant-bio">
                        <h1 class="plant-name">Mexicain</h1>
						<form action="php/ajouter.php" method="POST"class="adder">
                         <input type="hidden" name="name" value="Mexicain">
                     <input  type="submit" name="add_to_cart" value="ADD">
                     </form>
                    ...
                    <a href="#" class="plant-box grid plant-grid7">
                        <div class="plant-bio">
                            <h1 class="plant-name">lebanese</h1>
							<form action="php/ajouter.php" method="POST"class="adder">
                         <input type="hidden" name="name" value="lebanese">
                     <input  type="submit" name="add_to_cart" value="ADD">
                     </form>
                            <h3 class="plant-price">10DT</h3>
                        </div>
                        <a href="#" class="plant-box grid plant-grid8">
                            <div class="plant-bio">
                                <h1 class="plant-name">Makloub</h1>
								<form action="php/ajouter.php" method="POST"class="adder">
                         <input type="hidden" name="name" value="Makloub">
                     <input  type="submit" name="add_to_cart" value="ADD">
                     </form>
                                <h3 class="plant-price">10DT</h3>
                            </div>
